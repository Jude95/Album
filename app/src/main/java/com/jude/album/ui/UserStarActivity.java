...
import com.jude.album.presenter.UserStarPresenter;
 ...
 */
@RequiresPresenter(UserStarPresenter.class)
public class UserStarActivity extends BeamListActivity<UserStarPresenter,User> {
